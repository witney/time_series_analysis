...
function [lags, crosscorr, max_crosscorr_lag]=calculate_amp_crosscorr(eeg1,eeg2,samp_freq,low_freq,high_freq)
...
% [b,a]=butter(3,2*[low_freq high_freq]/samp_freq,'bandpass'); %creates filter

filtered1 = filtfilt(b,a,eeg1); %filters eeg1 between low_freq and high_freq
filtered2 = filtfilt(b,a,eeg2); %filters eeg2 between low_freq and high_freq
...
[crosscorr,lags]=xcorr(amp1, amp2,'coeff'); %calculates crosscorrelations between amplitude vectors
